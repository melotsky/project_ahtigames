<?php
/**
 * Template Name: Landing Page 004 Template
 */
...
$mob_img2 = wp_get_attachment_image_src(get_field('main_image_character_mob'), 'lpt003_mobile_main_character'); //main_image_character_mob
...
<div class="lp001_desktop" style="display: none">
    ...
    $desk_img2 = wp_get_attachment_image_src(get_field('main_image_desk_character'), 'lpt_tablet_queen_desktop'); //main_background_image_mob
