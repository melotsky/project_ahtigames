<?php
/**
 * Template Name: Landing Page 006 Template
 */
...
$mob_img2 = wp_get_attachment_image_src(get_field('main_image_character_mob'), 'lpt005_mobile_main_character'); //main_image_character_mob
        ...
        <?php if($mob_img1) :?>
            <div class="main_bg_mob_lp001" style="background-image: url(<?php _e($mob_img1[0])?>)">
                <div class="main_char_mob_temp002">
                    ...
                    <img src="<?php _e($mob_img2)?>" srcset="<?php echo wp_get_attachment_image_srcset( $mob_img_id, array( 700, 200 ) ); ?>" data-id="<?php echo $mob_img_id ?>" />       
                </div>
            </div>
        <?php endif; ?>
...
<div class="lp001_desktop" style="display: none">
    ...
    $desk_img2 = wp_get_attachment_image_src(get_field('main_image_desk_character'), 'lpt005_desktop_main_character'); //main_background_image_mob
        ...
        <?php 
            ...
            <div id="lp_tnc_mob" class="group fordeskty">
                <div class="lp_tnc_mob__content group showthis">
                    <p><?php the_field('terms_condition_lp')?> <a href="#mydiv2" class="html5lightbox"><?php the_field('popup_label_lp002')?></a></p>
                    <div class="footer__links group">
                        <div class="footer__links_tb">
                        <div class="footer__links_tb_cell">
                        <p class="group fl_one__mob">
