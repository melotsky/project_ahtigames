<?php
/**
 * Template Name: Landing Page 026 Template
 */
        ...
        <?php 
            ...
            <div id="lp_tnc_mob" class="group">
                ...
                <div class="lp_tnc_mob__content group">
                    <?php if (get_field('add_link_yzz') == '1'): ?>
                        <p class="add_link_yzz__mob">
                            <?php if(get_field('popup_label_lp002')) :?>
                                <a target="_blank" href="<?php the_field('target_link_yzz')?>" class=""><?php the_field('popup_label_lp002')?></a>
                            <?php endif; ?>
                        </p>                        
                    <?php else :?>
                        <p>
        ...
        <?php 
            ...
            <div id="lp_tnc_mob" class="group fordeskty">
                <div class="lp_tnc_mob__content group showthis">
                    <?php if (get_field('add_link_yzz') == '1'):?>
                        <p class="add_link_yzz__desk"><?php if(get_field('popup_label_lp002')) :?><a target="_blank" href="<?php the_field('target_link_yzz')?>" class=""><?php the_field('popup_label_lp002')?></a><?php endif;?></p>                            
                    <?php else :?>
