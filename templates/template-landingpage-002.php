<?php
/**
 * Template Name: Landing Page 002 Template
 */
...
$mob_img2 = wp_get_attachment_image_src(get_field('main_image_character_mob'), 'lpt_tablet_queen_mobile'); //main_image_character_mob
