<?php
/**
 * Template Name: Landing Page 009 Template
 */
...
$mob_img2 = wp_get_attachment_image_src(get_field('main_image_character_mob'), 'lpt009_mobile_main_character'); //main_image_character_mob
    ...
    <?php else: ?>
            <div id="lp_tnc_mob" class="group">
                <div class="lp_tnc_mob__content group">
                    ...
                    <div class="lp_tnc__linkonly">
                        <div class="lp_tnc__linkonly_table">
                            <div class="lp_tnc__linkonly_table_cell">
                                <?php the_field('link_label_lp')?> 
                            </div>    
                        </div>    
                    </div>
                    <div class="footer__links group">
...
<div class="lp001_desktop" style="display: none">
    ...
    $desk_img2 = wp_get_attachment_image_src(get_field('main_image_desk_character'), 'lpt009_desktop_main_character'); //main_background_image_mob
    ...
    <div id="lp001_desktop__thebg">
        <?php if($desk_img1) :?>
            <div class="main_bg_desk_lp001 temp002" style="background-image: url(<?php _e($desk_img1[0])?>)">
                ...
                <p><?php 
                //echo $ikstat = $desk_img2[0];
                //echo $image_id = pippin_get_image_id($desk_img2[0]); 
                ?></p>
        ...
        <?php 
            ...
            <div id="lp_tnc_mob" class="group fordeskty">
                <div class="lp_tnc_mob__content group showthis">
                    ...
                    <?php if( get_field('popup_label_lp002') ):?>
                    <a href="#mydiv2" class="html5lightbox"><?php the_field('popup_label_lp002')?></a></p>
                    <?php endif; ?>
                    <div class="footer__links group">
                        <div class="footer__links_tb">
                        <div class="footer__links_tb_cell">
